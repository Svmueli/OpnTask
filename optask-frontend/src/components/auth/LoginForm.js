  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const user = {
        ...
        role: response.role, // Ensure role is included in the response from the server
      };
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="submit"
            value="Login"
            className="w-full p-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-200 cursor-pointer"
          />
        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            className="w-full p-2 text-white bg-gray-800 rounded-md hover:bg-gray-900 transition duration-200 cursor-pointer"
          >
            Sign in with Github
          </button>
        </div>
